...
using CF = Wkg.Threading.Workloads.Queuing.Classless.ConstrainedFifo.ConstrainedFifo;

namespace Wkg.Tests.Threading.Workloads.Queuing.Classless.ConstrainedFifo;
...
public class ConstrainedFifoQdiscTests
{
    ...
    {
        IClassifyingQdisc<int> qdisc = CF.CreateBuilder(s_context)
