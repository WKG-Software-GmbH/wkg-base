...
public static class TypeArray
{
    ...
    public static Type[] Of<T1>() => [typeof(T1)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2>() => [typeof(T1), typeof(T2)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2, T3>() => [typeof(T1), typeof(T2), typeof(T3)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2, T3, T4>() => [typeof(T1), typeof(T2), typeof(T3), typeof(T4)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2, T3, T4, T5>() => [typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2, T3, T4, T5, T6>() => [typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2, T3, T4, T5, T6, T7>() => [typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7)];
    /// <summary>
    ...
    public static Type[] Of<T1, T2, T3, T4, T5, T6, T7, T8>() => [typeof(T1), typeof(T2), typeof(T3), typeof(T4), typeof(T5), typeof(T6), typeof(T7), typeof(T8)];
}